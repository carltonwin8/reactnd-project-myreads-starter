          ...
          <div>
            <div className="bookshelf">
              ...
              <div className="bookshelf-books">
                <ol className="books-grid">
                  <li>
                    <Book book={booksCurrent[0]}/>
                  </li>
                  <li>
                    <Book book={booksCurrent[1]}/>
                  </li>
                </ol>
              </div>
            </div>
            <div className="bookshelf">
              ...
              <div className="bookshelf-books">
                <ol className="books-grid">
                  <li>
                    <Book book={booksToRead[0]}/>
                  </li>
                  <li>
                    <Book book={booksToRead[1]}/>
                  </li>
                </ol>
              </div>
            </div>
            <div className="bookshelf">
              ...
              <div className="bookshelf-books">
                <ol className="books-grid">
                  <li>
                    <Book book={booksRead[0]}/>
                  </li>
                  <li>
                    <Book book={booksRead[1]}/>
                  </li>
                  <li>
                    <Book book={booksRead[2]}/>
                  </li>
                </ol>
              </div>
            </div>
